...
Tool.create(name: "Wheel barrow", user_id: User.find(5).id, category: "G tools", description: "The Marathon Yard Rover is one of the most popular two-wheel wheelbarrows on the market.", picture_url: "https://images-na.ssl-images-amazon.com/images/I/61cdEtG3RCL._SL1500_.jpg")
