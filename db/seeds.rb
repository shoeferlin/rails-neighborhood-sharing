...
Tool.create(name: "Troy-Bilt 382cc 30-Inch Riding Lawn", user_id: User.find(3).id, category: "Lawn mover", description: "The Troy-Bilt Neighborhood Rider is powered by a 382cc Auto Choke OHV engine with top forward speeds of 4.25 MPH and a 6-speed transmission.", picture_url: "https://images-na.ssl-images-amazon.com/images/I/81GrBMlwDjL._SL1500_.jpg")
Tool.create(name: "420cc 42-Inch Riding Lawn Tractor", user_id: User.find(4).id, category: "Lawn mower", description: "Tackle your lawn mowing tasks with ease this year. The 42-inch Yard Machines Riding Mower is powered by a 420cc engine.", picture_url: "https://images-na.ssl-images-amazon.com/images/I/71tyY6oyXHL._SL1424_.jpg")
