...
Tool.create(name: "Jackson M6T22 6 Cubic foot", user_id: User.find(5).id, category: "Wheel barrow", description: "Steel undercarriage with roll bars on the front", picture_url: "https://images-na.ssl-images-amazon.com/images/I/4120lRLvTTL.jpg")
...
Tool.create(name: "Greenworks 20-Inch 12 Amp", user_id: User.find(7).id, category: "Lawn mover", description: "Powerful 12 Amp motor for getting the job done.", picture_url: "https://images-na.ssl-images-amazon.com/images/I/71LApYGfJ-L._SL1500_.jpg")
Tool.create(name: "Yard Machines 140Cc 20-Inch Push Mower", user_id: User.find(10).id, category: "Lawn mover", description: "The Yard Machines 140cc 4-cycle push lawnmower is perfect for small to medium-sized residential yards and delivers solid, efficient power to tackle the job.", picture_url: "https://images-na.ssl-images-amazon.com/images/I/615%2BvEiuEEL._SL1226_.jpg")
Tool.create(name: "Troy-Bilt 382cc 30-Inch Riding Lawn", user_id: User.find(10).id, category: "Lawn mover", description: "The Troy-Bilt Neighborhood Rider is powered by a 382cc Auto Choke OHV engine with top forward speeds of 4.25 MPH and a 6-speed transmission.", picture_url: "https://images-na.ssl-images-amazon.com/images/I/81GrBMlwDjL._SL1500_.jpg")
Tool.create(name: "420cc 42-Inch Riding Lawn Tractor", user_id: User.find(10).id, category: "Lawn mower", description: "Tackle your lawn mowing tasks with ease this year. The 42-inch Yard Machines Riding Mower is powered by a 420cc engine.", picture_url: "https://images-na.ssl-images-amazon.com/images/I/71tyY6oyXHL._SL1424_.jpg")
Tool.create(name: "Honda HRR216K9VKA", user_id: User.find(10).id, category: "Lawn mower", description: "Smart Drive - Variable Speed 0 to 4 mph., Mulch, Bag, Discharge. No Tools or attachments needed, Micro cut Twin Blades.", picture_url: "https://images-na.ssl-images-amazon.com/images/I/61RaadY8eXL._SL1200_.jpg")
